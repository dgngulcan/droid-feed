...
import com.droidfeed.data.model.RssChannel
...
class RssXmlParser {
    ...
    private fun parseChannelImage(parser: XmlPullParser): RssChannel {
    ...
    private fun readArticle(parser: XmlPullParser, rssChannel: RssChannel): Article {
        val article = Article()
